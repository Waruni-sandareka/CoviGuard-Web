    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="<?php echo e(route('userDashBoard')); ?>">
...
<div class="container-fluid">
    ...
    <div class="row local-news-row">
        <div class="col-8">
            <?php echo $__env->make('user.News.news-page-carousal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <div class="col-4">
            <?php echo $__env->make('user.News.news_page_local-contacts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    ...
    <div class="row world-news">
        <?php echo $__env->make('user.News.world_news_page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>
</div>
...
<?php /**PATH D:\Coviguard\CoviGuard-VaccinationSystem-main\CoviGuard-VaccinationSystem-main\resources\views/user/News/news_page.blade.php ENDPATH**/ ?>